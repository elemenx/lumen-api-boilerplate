...
class CaptchaService
{
    ...
    public function __construct(
        ...
        $this->backgrounds = [];
        $this->fonts = [];
        foreach (glob(base_path('resources/captcha/backgrounds/*.png')) as $background) {
            $this->backgrounds[] = $background;
        }
        foreach (glob(base_path('resources/captcha/fonts/*.ttf')) as $font) {
            $this->fonts[] = $font;
        }
    }
     ...
     * @return bool
     */
    public function checkCaptchaById($value, $captchaId)
    {
